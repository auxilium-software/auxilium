    ...
    public function __construct(bool $newInstance = false, array $newVariables = [])
    {
        ...
        if($newInstance)
        {
            ...
            $this->Variables = [
                ...
                "INSTANCE_CREDENTIAL_REDIS_HOST"        => $newVariables['redis-host'],
                "INSTANCE_CREDENTIAL_REDIS_PORT"        => $newVariables['redis-port'],
                "INSTANCE_CREDENTIAL_REDIS_PASSWORD"    => $newVariables['redis-password'],
                "INSTANCE_CREDENTIAL_REDIS_DATABASE"    => $newVariables['redis-database'],
        ...
        else
        {
            $this->Variables = [
                ...
                "INSTANCE_CREDENTIAL_REDIS_HOST"        => INSTANCE_CREDENTIAL_REDIS_HOST,
                "INSTANCE_CREDENTIAL_REDIS_PORT"        => INSTANCE_CREDENTIAL_REDIS_PORT,
                "INSTANCE_CREDENTIAL_REDIS_PASSWORD"    => INSTANCE_CREDENTIAL_REDIS_PASSWORD,
                "INSTANCE_CREDENTIAL_REDIS_DATABASE"    => INSTANCE_CREDENTIAL_REDIS_DATABASE,
...
const INSTANCE_CREDENTIAL_REDIS_HOST        = "{$this->Variables["INSTANCE_CREDENTIAL_REDIS_HOST"]}";
const INSTANCE_CREDENTIAL_REDIS_PORT        = {$this->Variables["INSTANCE_CREDENTIAL_REDIS_PORT"]};
const INSTANCE_CREDENTIAL_REDIS_PASSWORD    = "{$this->Variables["INSTANCE_CREDENTIAL_REDIS_PASSWORD"]}";
const INSTANCE_CREDENTIAL_REDIS_DATABASE    = {$this->Variables["INSTANCE_CREDENTIAL_REDIS_DATABASE"]};
