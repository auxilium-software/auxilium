        ...
        let innerDataDisplay = (downloadUrl, url, metadata) => {
            ...
            http.onreadystatechange = (e) => {
                if (http.readyState == 4 && !responseHad) {
                    ...
                    let uuidExtractionRegex = /[a-f0-9]{8}\-[a-f0-9]{4}\-[a-f0-9]{4}\-[a-f0-9]{4}\-[a-f0-9]{12}/g;
                    ...
                    if (response["from"] == null) {
                        ...
                        if (auxInboxRegex.test(response["from"])) {
                            ...
                            //console.log("SENT BY " + senderUuid[0]);
    ...
    #mimeDisplay() {
        ...
        if (this.#data == null) {
            ...
            let displayLogic = (mediaType, size, data = null) => {
                ...
                if (size > (1024 * 1024)) { // Too big to display inline (1MB), offer download
                    displayAs = "file";
                }
