...
for file in icons/*; do
    ...
    if [[ "$parsed_str" == *"$skip_suffix"* ]]; then
        ...
        echo "    background-image: url(\"/assets/icons/"$parsed_str"_black_48dp.svg\");" >> $icons_css
        echo "}" >> $icons_css
        echo ".$icon_name-icon-inverted {" >> $icons_css
        echo "    background-image: url(\"/assets/icons/"$parsed_str"_white_48dp.svg\");" >> $icons_css
        echo "}" >> $icons_css
        ...
        echo "    background-image: url(\"/assets/icons/"$parsed_str"_white_48dp.svg\");" >> $dark_mode_icons_css
        echo "}" >> $dark_mode_icons_css
        echo ".$icon_name-icon-inverted {" >> $dark_mode_icons_css
        echo "    background-image: url(\"/assets/icons/"$parsed_str"_black_48dp.svg\");" >> $dark_mode_icons_css
        echo "}" >> $dark_mode_icons_css
    fi
done
