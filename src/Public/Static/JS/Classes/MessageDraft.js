class MessageDraft {
    ...
    constructor(draftId, floating = false) {
        ...
        LanguagePack.whenTemplateAvailable("ui_text/start_typing_a_name", (templ) => {if (templ != null) {this.#recipientsBox.placeholder = capitalize(templ);}});
        ...
        LanguagePack.whenTemplateAvailable("ui_text/start_typing_your_message", (templ) => {if (templ != null) {this.#textArea.placeholder = capitalize(templ);}});
        ...
        LanguagePack.whenTemplateAvailable("ui_text/send_message", (templ) => {if (templ != null) {this.#sendButton.value = capitalize(templ);}});
